...
class Sms extends Model
{
    ...
    // $data->partner_id = '1'; // Можно указать ваш ID партнера, если вы интегрируете код в чужую систему
        ...
        if ($sms->status == "OK") { // Запрос выполнен успешно
            ...
            //Yii::$app->session->setFlash('error', 'В процессе отправки сообщения возникла ошибка!<br> Код ошибки: ' . $sms->status_code .'<br>Текст ошибки: '.$sms->status_text);
        ...
        if ($request->status == "OK") { // Запрос выполнен успешно
            ...
            $msg = "Общая стоимость: $request->total_cost ";
